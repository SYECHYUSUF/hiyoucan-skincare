<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="space-x-2">
                <a href="{{ route('seller.products.index') }}" class="bg-hiyoucan-700 text-white px-4 py-2 rounded text-sm hover:bg-hiyoucan-800">My Products</a>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-hiyoucan-500">
