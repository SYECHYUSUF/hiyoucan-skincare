                ...
                <form action="{{ route('seller.products.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="url" name="image_url" placeholder="https://example.com/image.jpg" class="mt-1 w-full border-gray-300 rounded-md shadow-sm focus:ring-hiyoucan-500 focus:border-hiyoucan-500" required>
                            <p class="text-xs text-gray-500 mt-1">Gunakan link gambar dari internet (Unsplash/Google) untuk saat ini.</p>
                        </div>
