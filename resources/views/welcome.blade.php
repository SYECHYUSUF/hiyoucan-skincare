            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-20">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:space-x-8">
                        <a href="/" class="text-gray-900 hover:text-hiyoucan-600 font-medium">Home</a>
                        <a href="{{ route('shop.index') }}" class="text-gray-500 hover:text-hiyoucan-600 font-medium">Shop</a>
                        <a href="#" class="text-gray-500 hover:text-hiyoucan-600 font-medium">Skin Care</a>
                        <a href="#" class="text-gray-500 hover:text-hiyoucan-600 font-medium">About</a>
                    </div>

                    <div class="flex items-center space-x-6">
                        <button class="text-gray-500 hover:text-hiyoucan-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 items-center min-h-[600px]">
                    <div class="px-6 py-12 md:px-12 lg:pr-24 z-10">
                        ...
                        <p class="text-gray-600 mb-8 text-lg leading-relaxed">
                            Rasakan sentuhan alami untuk kulit sehatmu. Hiyoucan menghadirkan perawatan kulit organik yang aman dan efektif.
                        </p>
                        <div class="flex gap-4">
                            <a href="#" class="bg-hiyoucan-700 text-white px-8 py-3 rounded-full hover:bg-hiyoucan-800 transition shadow-lg">
                                Shop Now
                            </a>
                    ...
                    <div class="relative h-full w-full">
                        <img src="https://images.unsplash.com/photo-1616683693504-3ea7e9ad6fec?q=80&w=1887&auto=format&fit=crop" 
                             alt="Hiyoucan Model" 
                             class="object-cover w-full h-[500px] md:h-[700px] rounded-bl-[100px]">
                        
                        <div class="absolute bottom-10 left-10 bg-white/80 backdrop-blur p-4 rounded-lg shadow-sm hidden md:block">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                    <div class="flex flex-col items-center group">
                        <div class="w-12 h-12 mb-3 text-hiyoucan-600 bg-earth-100 rounded-full flex items-center justify-center group-hover:bg-hiyoucan-600 group-hover:text-white transition">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[500px]">
                    <div class="relative group overflow-hidden rounded-2xl md:col-span-1 h-64 md:h-full bg-white">
                        <img src="https://images.unsplash.com/photo-1608248597279-f99d160bfbc8?q=80&w=1000&auto=format&fit=crop" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" alt="Face Cream">
                    ...
                    <div class="md:col-span-2 grid grid-cols-2 grid-rows-2 gap-6 h-full">
                        <div class="col-span-2 relative group overflow-hidden rounded-2xl bg-white">
                            <img src="https://images.unsplash.com/photo-1556228578-0d85b1a4d571?q=80&w=1000&auto=format&fit=crop" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" alt="Serum">
                        ...
                        <div class="relative group overflow-hidden rounded-2xl bg-white">
                            <img src="https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=1000&auto=format&fit=crop" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" alt="Cleanser">
                            <div class="absolute bottom-4 left-4">
                                <button class="bg-white text-hiyoucan-900 px-4 py-1 rounded-full text-sm font-medium shadow">Cleanser</button>
                            </div>
                        </div>
                        <div class="relative group overflow-hidden rounded-2xl bg-white">
                            <img src="https://images.unsplash.com/photo-1629198688000-71f23e745b6e?q=80&w=1000&auto=format&fit=crop" class="w-full h-full object-cover transition duration-500 group-hover:scale-105" alt="Toner">
                            <div class="absolute bottom-4 left-4">
                                <button class="bg-white text-hiyoucan-900 px-4 py-1 rounded-full text-sm font-medium shadow">Toner</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    <div class="group">
                        <div class="relative aspect-square overflow-hidden rounded-xl bg-earth-100 mb-4">
                            <img src="https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?q=80&w=1000&auto=format&fit=crop" class="object-cover w-full h-full group-hover:scale-110 transition duration-500">
                            <button class="absolute bottom-4 right-4 bg-white p-2 rounded-full shadow-md hover:bg-hiyoucan-600 hover:text-white transition">
                    ...
                    <div class="group">
                        <div class="relative aspect-square overflow-hidden rounded-xl bg-earth-100 mb-4">
                            <img src="https://images.unsplash.com/photo-1601049541289-9b1b7bbbfe19?q=80&w=1000&auto=format&fit=crop" class="object-cover w-full h-full group-hover:scale-110 transition duration-500">
                            <button class="absolute bottom-4 right-4 bg-white p-2 rounded-full shadow-md hover:bg-hiyoucan-600 hover:text-white transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                            </button>
                        </div>
                    ...
                    <div class="group">
                        <div class="relative aspect-square overflow-hidden rounded-xl bg-earth-100 mb-4">
                            <img src="https://images.unsplash.com/photo-1620916297397-a4a5402a3c6c?q=80&w=1000&auto=format&fit=crop" class="object-cover w-full h-full group-hover:scale-110 transition duration-500">
                            <button class="absolute bottom-4 right-4 bg-white p-2 rounded-full shadow-md hover:bg-hiyoucan-600 hover:text-white transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                            </button>
                        </div>
                    ...
                    <div class="group">
                        <div class="relative aspect-square overflow-hidden rounded-xl bg-earth-100 mb-4">
                            <img src="https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?q=80&w=1000&auto=format&fit=crop" class="object-cover w-full h-full group-hover:scale-110 transition duration-500">
                            <button class="absolute bottom-4 right-4 bg-white p-2 rounded-full shadow-md hover:bg-hiyoucan-600 hover:text-white transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                            </button>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    <div>
                        ...
                        <p class="text-gray-400 text-sm leading-relaxed">
                            Kami berdedikasi untuk menyediakan produk perawatan kulit organik terbaik untuk kecantikan alami Anda.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            <input type="email" placeholder="Your email" class="px-4 py-2 bg-hiyoucan-800 border-none text-white rounded-l focus:ring-1 focus:ring-hiyoucan-500 w-full">
