...
<head>
    ...
    <style>
        ...
        .rating-input label { cursor: pointer; width: 25px; font-size: 25px; color: #ddd; float: right; }
        .rating-input input:checked ~ label, .rating-input label:hover, .rating-input label:hover ~ label { color: #fbbf24; }
...
<body class="antialiased font-sans text-gray-700 bg-white">
    ...
    <div class="pt-28 pb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-16">
            <h2 class="text-2xl font-bold text-hiyoucan-900 mb-6">Customer Reviews</h2>
            ...
            @auth
                ...
                <div class="bg-gray-50 p-6 rounded-lg mb-8 border border-gray-200">
                    ...
                    <form action="{{ route('reviews.store', $product->id) }}" method="POST">
                        ...
                        <button type="submit" class="bg-hiyoucan-700 text-white px-6 py-2 rounded-md text-sm hover:bg-hiyoucan-800">Submit Review</button>
                    </form>
                </div>
                @endif
            @endauth
