<x-public-layout>
    <div class="pt-32 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ showFilters: false }">
        ...
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12"> <div class="lg:hidden mb-4">
            ...
            <aside :class="{'block': showFilters, 'hidden': !showFilters}" class="hidden lg:block w-full lg:w-1/4 flex-shrink-0 transition-all duration-300" data-aos="fade-right">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                ...
                                <input type="number" name="min_price" value="{{ request('min_price') }}" class="w-full border-gray-200 rounded-lg text-sm focus:ring-hiyoucan-500" placeholder="0">
                            </div>
                            <div>
                                <label class="text-xs text-gray-500">Max</label>
                                <input type="number" name="max_price" value="{{ request('max_price') }}" class="w-full border-gray-200 rounded-lg text-sm focus:ring-hiyoucan-500" placeholder="Max">
                            </div>
                        </div>
                    </div>
            ...
            <main class="w-full lg:w-3/4">
                <div class="flex flex-col sm:flex-row justify-between items-center mb-8 bg-white p-4 rounded-xl shadow-sm border border-gray-100" data-aos="fade-down">
                    ...
                    <div class="flex items-center space-x-3 w-full sm:w-auto">
                        ...
                        <select onchange="window.location.href=this.value" class="w-full sm:w-auto border-none bg-gray-50 text-sm font-bold text-gray-700 rounded-lg focus:ring-0 cursor-pointer hover:bg-gray-100 transition py-2 pl-3 pr-8">
